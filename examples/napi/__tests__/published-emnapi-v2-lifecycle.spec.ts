...
test.skipIf(!isWasi)(
  'generated eager WASI loader stays usable with published emnapi v2',
  (t) => {
    const result = spawnSync(
      process.execPath,
      [join(__dirname, 'published-emnapi-v2-lifecycle.js'), wasiLoaderSuffix],
      {
        encoding: 'utf8',
        env: process.env,
        timeout: 30_000,
    ...
    t.regex(result.stdout, /published emnapi v2 lifecycle passed:/)
  },
)
