...
export interface BufferHeritageOverride extends __NapiRsBuffer_1 {}
...
export declare class Blake2BHasher {
  ...
  update(data: import("buffer").Buffer): void
}
...
export declare function acceptStream(stream: ReadableStream<Uint8Array>): Promise<import("buffer").Buffer>
...
export declare function acceptUint8ClampedSliceAndBufferSlice(a: import("buffer").Buffer, b: Uint8ClampedArray): bigint
...
export declare function appendBuffer(buf: import("buffer").Buffer): import("buffer").Buffer
...
export declare function asyncReduceBuffer(buf: import("buffer").Buffer): Promise<number>
...
external: import("buffer").Buffer
}, external: import("buffer").Buffer): "line\nnext" | `template\n${import("buffer").Buffer extends Uint8Array ? "buffer" : "other"}`

export declare function bufferDestructureBinding({ Buffer }: { Buffer: string }, value: import("buffer").Buffer): import("buffer").Buffer

export declare function bufferGenericConstraint<T extends import("buffer").Buffer>(value: T): T

export declare function bufferGenericShadow<Buffer>(value: Buffer): Buffer

export declare function bufferLenAsync(buf: import("buffer").Buffer): Promise<number>
...
export declare function compressSync(_: string | Uint8Array): import("buffer").Buffer
...
export declare function createReadableStreamFromClass(readableStreamClass: typeof ReadableStream): ReadableStream<import("buffer").Buffer>
...
export interface Data {
  data: string | import("buffer").Buffer
}
...
export declare function getBuffer(): import("buffer").Buffer

export declare function getBufferSlice(): import("buffer").Buffer
...
export declare function getEmptyBuffer(): import("buffer").Buffer
...
export declare function readFileAsync(path: string): Promise<import("buffer").Buffer>
...
export declare function validateBuffer(b: import("buffer").Buffer): number

export declare function validateBufferSlice(input: import("buffer").Buffer): number
...
export declare namespace xxh2 {
  ...
  export function xxh3Xxh64Alias(input: import("buffer").Buffer): bigint
}
...
export declare namespace xxh3 {
  ...
  export class Xxh3 {
    constructor()
    /** update */
    update(input: import("buffer").Buffer): void
    digest(): bigint
  }
  export const ALIGNMENT: number
  /** xxh128 function */
  export function xxh128(input: import("buffer").Buffer): bigint
  export function xxh3_64(input: import("buffer").Buffer): bigint
}
