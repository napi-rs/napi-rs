...
function __napi_rs_initialize_modules(__napiInstance) {
  ...
  __napiInstance.exports['__napi_register__Pet_struct_334']?.()
  __napiInstance.exports['__napi_register__tsfn_in_either_335']?.()
  __napiInstance.exports['__napi_register__get_buffer_336']?.()
  __napiInstance.exports['__napi_register__append_buffer_337']?.()
  __napiInstance.exports['__napi_register__get_empty_buffer_338']?.()
  __napiInstance.exports['__napi_register__convert_u32_array_339']?.()
  __napiInstance.exports['__napi_register__create_external_typed_array_340']?.()
  __napiInstance.exports['__napi_register__mutate_typed_array_341']?.()
  __napiInstance.exports['__napi_register__deref_uint8_array_342']?.()
  __napiInstance.exports['__napi_register__buffer_pass_through_343']?.()
  __napiInstance.exports['__napi_register__array_buffer_pass_through_344']?.()
  __napiInstance.exports['__napi_register__accept_slice_345']?.()
  __napiInstance.exports['__napi_register__accept_arraybuffer_346']?.()
  __napiInstance.exports['__napi_register__u8_array_to_array_347']?.()
  __napiInstance.exports['__napi_register__i8_array_to_array_348']?.()
  __napiInstance.exports['__napi_register__u16_array_to_array_349']?.()
  __napiInstance.exports['__napi_register__i16_array_to_array_350']?.()
  __napiInstance.exports['__napi_register__u32_array_to_array_351']?.()
  __napiInstance.exports['__napi_register__i32_array_to_array_352']?.()
  __napiInstance.exports['__napi_register__f32_array_to_array_353']?.()
  __napiInstance.exports['__napi_register__f64_array_to_array_354']?.()
  __napiInstance.exports['__napi_register__u64_array_to_array_355']?.()
  __napiInstance.exports['__napi_register__i64_array_to_array_356']?.()
  __napiInstance.exports['__napi_register__accept_uint8_clamped_slice_357']?.()
  __napiInstance.exports['__napi_register__accept_uint8_clamped_slice_and_buffer_slice_358']?.()
  __napiInstance.exports['__napi_register__AsyncBuffer_impl_359']?.()
  __napiInstance.exports['__napi_register__async_reduce_buffer_360']?.()
  __napiInstance.exports['__napi_register__async_buffer_to_array_361']?.()
  __napiInstance.exports['__napi_register__u_init8_array_from_string_362']?.()
}
