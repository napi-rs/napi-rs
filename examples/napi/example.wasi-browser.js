...
function __napi_rs_initialize_modules(__napiInstance) {
  ...
  __napiInstance.exports['__napi_register__async_plus_100_290']?.()
  __napiInstance.exports['__napi_register__call_then_on_promise_291']?.()
  __napiInstance.exports['__napi_register__call_catch_on_promise_292']?.()
  __napiInstance.exports['__napi_register__call_finally_on_promise_293']?.()
  __napiInstance.exports['__napi_register__JsRepo_struct_294']?.()
  __napiInstance.exports['__napi_register__JsRepo_impl_297']?.()
  __napiInstance.exports['__napi_register__JsRemote_struct_298']?.()
  __napiInstance.exports['__napi_register__JsRemote_impl_301']?.()
  __napiInstance.exports['__napi_register__CSSRuleList_struct_302']?.()
  __napiInstance.exports['__napi_register__CSSRuleList_impl_306']?.()
  __napiInstance.exports['__napi_register__CSSStyleSheet_struct_307']?.()
  __napiInstance.exports['__napi_register__AnotherCSSStyleSheet_struct_308']?.()
  __napiInstance.exports['__napi_register__AnotherCSSStyleSheet_impl_310']?.()
  __napiInstance.exports['__napi_register__CSSStyleSheet_impl_314']?.()
  __napiInstance.exports['__napi_register__PackageJson_struct_315']?.()
  __napiInstance.exports['__napi_register__read_package_json_316']?.()
  __napiInstance.exports['__napi_register__get_package_json_name_317']?.()
  __napiInstance.exports['__napi_register__test_serde_roundtrip_318']?.()
  __napiInstance.exports['__napi_register__test_serde_big_number_precision_319']?.()
  __napiInstance.exports['__napi_register__test_serde_buffer_bytes_320']?.()
  __napiInstance.exports['__napi_register__pass_set_to_rust_321']?.()
  __napiInstance.exports['__napi_register__pass_set_to_js_322']?.()
  __napiInstance.exports['__napi_register__pass_set_with_hasher_to_js_323']?.()
  __napiInstance.exports['__napi_register__btree_set_to_rust_324']?.()
  __napiInstance.exports['__napi_register__btree_set_to_js_325']?.()
  __napiInstance.exports['__napi_register__return_from_shared_crate_326']?.()
  __napiInstance.exports['__napi_register__contains_327']?.()
  __napiInstance.exports['__napi_register__concat_str_328']?.()
  __napiInstance.exports['__napi_register__concat_utf16_329']?.()
  __napiInstance.exports['__napi_register__concat_latin1_330']?.()
  __napiInstance.exports['__napi_register__roundtrip_str_331']?.()
  __napiInstance.exports['__napi_register__return_c_string_332']?.()
  __napiInstance.exports['__napi_register__set_symbol_in_obj_333']?.()
  __napiInstance.exports['__napi_register__create_symbol_334']?.()
  __napiInstance.exports['__napi_register__create_symbol_for_335']?.()
  __napiInstance.exports['__napi_register__DelaySum_impl_336']?.()
  __napiInstance.exports['__napi_register__without_abort_controller_337']?.()
  __napiInstance.exports['__napi_register__with_abort_controller_338']?.()
  __napiInstance.exports['__napi_register__AsyncTaskVoidReturn_impl_339']?.()
  __napiInstance.exports['__napi_register__async_task_void_return_340']?.()
  __napiInstance.exports['__napi_register__AsyncTaskOptionalReturn_impl_341']?.()
  __napiInstance.exports['__napi_register__async_task_optional_return_342']?.()
  __napiInstance.exports['__napi_register__AsyncTaskReadFile_impl_343']?.()
  __napiInstance.exports['__napi_register__async_task_read_file_344']?.()
  __napiInstance.exports['__napi_register__call_threadsafe_function_345']?.()
  __napiInstance.exports['__napi_register__call_long_threadsafe_function_346']?.()
  __napiInstance.exports['__napi_register__threadsafe_function_throw_error_347']?.()
  __napiInstance.exports['__napi_register__threadsafe_function_fatal_mode_348']?.()
  __napiInstance.exports['__napi_register__threadsafe_function_fatal_mode_error_349']?.()
  __napiInstance.exports['__napi_register__threadsafe_function_closure_capture_350']?.()
  __napiInstance.exports['__napi_register__tsfn_call_with_callback_351']?.()
  __napiInstance.exports['__napi_register__tsfn_async_call_352']?.()
  __napiInstance.exports['__napi_register__accept_threadsafe_function_353']?.()
  __napiInstance.exports['__napi_register__accept_threadsafe_function_fatal_354']?.()
  __napiInstance.exports['__napi_register__accept_threadsafe_function_tuple_args_355']?.()
  __napiInstance.exports['__napi_register__tsfn_return_promise_356']?.()
  __napiInstance.exports['__napi_register__tsfn_return_promise_timeout_357']?.()
  __napiInstance.exports['__napi_register__tsfn_throw_from_js_358']?.()
  __napiInstance.exports['__napi_register__spawn_thread_in_thread_359']?.()
  __napiInstance.exports['__napi_register__Pet_struct_360']?.()
  __napiInstance.exports['__napi_register__tsfn_in_either_361']?.()
  __napiInstance.exports['__napi_register__MyVec_struct_362']?.()
  __napiInstance.exports['__napi_register__get_my_vec_363']?.()
  __napiInstance.exports['__napi_register__get_buffer_364']?.()
  __napiInstance.exports['__napi_register__get_buffer_slice_365']?.()
  __napiInstance.exports['__napi_register__append_buffer_366']?.()
  __napiInstance.exports['__napi_register__get_empty_buffer_367']?.()
  __napiInstance.exports['__napi_register__create_external_buffer_slice_368']?.()
  __napiInstance.exports['__napi_register__create_buffer_slice_from_copied_data_369']?.()
  __napiInstance.exports['__napi_register__get_empty_typed_array_370']?.()
  __napiInstance.exports['__napi_register__convert_u32_array_371']?.()
  __napiInstance.exports['__napi_register__create_external_typed_array_372']?.()
  __napiInstance.exports['__napi_register__mutate_typed_array_373']?.()
  __napiInstance.exports['__napi_register__deref_uint8_array_374']?.()
  __napiInstance.exports['__napi_register__buffer_pass_through_375']?.()
  __napiInstance.exports['__napi_register__buffer_with_async_block_376']?.()
  __napiInstance.exports['__napi_register__array_buffer_pass_through_377']?.()
  __napiInstance.exports['__napi_register__accept_slice_378']?.()
  __napiInstance.exports['__napi_register__accept_arraybuffer_379']?.()
  __napiInstance.exports['__napi_register__create_arraybuffer_380']?.()
  __napiInstance.exports['__napi_register__u8_array_to_array_381']?.()
  __napiInstance.exports['__napi_register__i8_array_to_array_382']?.()
  __napiInstance.exports['__napi_register__u16_array_to_array_383']?.()
  __napiInstance.exports['__napi_register__i16_array_to_array_384']?.()
  __napiInstance.exports['__napi_register__u32_array_to_array_385']?.()
  __napiInstance.exports['__napi_register__i32_array_to_array_386']?.()
  __napiInstance.exports['__napi_register__f32_array_to_array_387']?.()
  __napiInstance.exports['__napi_register__f64_array_to_array_388']?.()
  __napiInstance.exports['__napi_register__u64_array_to_array_389']?.()
  __napiInstance.exports['__napi_register__i64_array_to_array_390']?.()
  __napiInstance.exports['__napi_register__accept_uint8_clamped_slice_391']?.()
  __napiInstance.exports['__napi_register__accept_uint8_clamped_slice_and_buffer_slice_392']?.()
  __napiInstance.exports['__napi_register__AsyncBuffer_impl_393']?.()
  __napiInstance.exports['__napi_register__async_reduce_buffer_394']?.()
  __napiInstance.exports['__napi_register__async_buffer_to_array_395']?.()
  __napiInstance.exports['__napi_register__u_init8_array_from_string_396']?.()
  __napiInstance.exports['__napi_register__AsyncReader_impl_397']?.()
  __napiInstance.exports['__napi_register__Reader_struct_398']?.()
  __napiInstance.exports['__napi_register__Reader_impl_400']?.()
}
