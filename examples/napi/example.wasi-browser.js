...
function __napi_rs_initialize_modules(__napiInstance) {
  ...
  __napiInstance.exports['__napi_register__esm_resolve_298']?.()
  __napiInstance.exports['__napi_register__JsRepo_struct_299']?.()
  __napiInstance.exports['__napi_register__JsRepo_impl_302']?.()
  __napiInstance.exports['__napi_register__JsRemote_struct_303']?.()
  __napiInstance.exports['__napi_register__JsRemote_impl_306']?.()
  __napiInstance.exports['__napi_register__CSSRuleList_struct_307']?.()
  __napiInstance.exports['__napi_register__CSSRuleList_impl_311']?.()
  __napiInstance.exports['__napi_register__CSSStyleSheet_struct_312']?.()
  __napiInstance.exports['__napi_register__AnotherCSSStyleSheet_struct_313']?.()
  __napiInstance.exports['__napi_register__AnotherCSSStyleSheet_impl_315']?.()
  __napiInstance.exports['__napi_register__CSSStyleSheet_impl_319']?.()
  __napiInstance.exports['__napi_register__PackageJson_struct_320']?.()
  __napiInstance.exports['__napi_register__read_package_json_321']?.()
  __napiInstance.exports['__napi_register__get_package_json_name_322']?.()
  __napiInstance.exports['__napi_register__test_serde_roundtrip_323']?.()
  __napiInstance.exports['__napi_register__test_serde_big_number_precision_324']?.()
  __napiInstance.exports['__napi_register__test_serde_buffer_bytes_325']?.()
  __napiInstance.exports['__napi_register__pass_set_to_rust_326']?.()
  __napiInstance.exports['__napi_register__pass_set_to_js_327']?.()
  __napiInstance.exports['__napi_register__pass_set_with_hasher_to_js_328']?.()
  __napiInstance.exports['__napi_register__btree_set_to_rust_329']?.()
  __napiInstance.exports['__napi_register__btree_set_to_js_330']?.()
  __napiInstance.exports['__napi_register__return_from_shared_crate_331']?.()
  __napiInstance.exports['__napi_register__accept_stream_332']?.()
  __napiInstance.exports['__napi_register__create_readable_stream_333']?.()
  __napiInstance.exports['__napi_register__create_readable_stream_from_class_334']?.()
  __napiInstance.exports['__napi_register__contains_335']?.()
  __napiInstance.exports['__napi_register__concat_str_336']?.()
  __napiInstance.exports['__napi_register__concat_utf16_337']?.()
  __napiInstance.exports['__napi_register__concat_latin1_338']?.()
  __napiInstance.exports['__napi_register__roundtrip_str_339']?.()
  __napiInstance.exports['__napi_register__return_c_string_340']?.()
  __napiInstance.exports['__napi_register__set_symbol_in_obj_341']?.()
  __napiInstance.exports['__napi_register__create_symbol_342']?.()
  __napiInstance.exports['__napi_register__create_symbol_for_343']?.()
  __napiInstance.exports['__napi_register__DelaySum_impl_344']?.()
  __napiInstance.exports['__napi_register__without_abort_controller_345']?.()
  __napiInstance.exports['__napi_register__with_abort_controller_346']?.()
  __napiInstance.exports['__napi_register__AsyncTaskVoidReturn_impl_347']?.()
  __napiInstance.exports['__napi_register__async_task_void_return_348']?.()
  __napiInstance.exports['__napi_register__AsyncTaskOptionalReturn_impl_349']?.()
  __napiInstance.exports['__napi_register__async_task_optional_return_350']?.()
  __napiInstance.exports['__napi_register__AsyncTaskReadFile_impl_351']?.()
  __napiInstance.exports['__napi_register__async_task_read_file_352']?.()
  __napiInstance.exports['__napi_register__call_threadsafe_function_353']?.()
  __napiInstance.exports['__napi_register__call_long_threadsafe_function_354']?.()
  __napiInstance.exports['__napi_register__threadsafe_function_throw_error_355']?.()
  __napiInstance.exports['__napi_register__threadsafe_function_fatal_mode_356']?.()
  __napiInstance.exports['__napi_register__threadsafe_function_fatal_mode_error_357']?.()
  __napiInstance.exports['__napi_register__threadsafe_function_closure_capture_358']?.()
  __napiInstance.exports['__napi_register__tsfn_call_with_callback_359']?.()
  __napiInstance.exports['__napi_register__tsfn_async_call_360']?.()
  __napiInstance.exports['__napi_register__accept_threadsafe_function_361']?.()
  __napiInstance.exports['__napi_register__accept_threadsafe_function_fatal_362']?.()
  __napiInstance.exports['__napi_register__accept_threadsafe_function_tuple_args_363']?.()
  __napiInstance.exports['__napi_register__tsfn_return_promise_364']?.()
  __napiInstance.exports['__napi_register__tsfn_return_promise_timeout_365']?.()
  __napiInstance.exports['__napi_register__tsfn_throw_from_js_366']?.()
  __napiInstance.exports['__napi_register__spawn_thread_in_thread_367']?.()
  __napiInstance.exports['__napi_register__Pet_struct_368']?.()
  __napiInstance.exports['__napi_register__tsfn_in_either_369']?.()
  __napiInstance.exports['__napi_register__MyVec_struct_370']?.()
  __napiInstance.exports['__napi_register__get_my_vec_371']?.()
  __napiInstance.exports['__napi_register__CustomU32_372']?.()
  __napiInstance.exports['__napi_register__MyPromise_373']?.()
  __napiInstance.exports['__napi_register__Nullable_374']?.()
  __napiInstance.exports['__napi_register__VoidNullable_375']?.()
  __napiInstance.exports['__napi_register__RuleHandler_376']?.()
  __napiInstance.exports['__napi_register__Rule_struct_377']?.()
  __napiInstance.exports['__napi_register__call_rule_handler_378']?.()
  __napiInstance.exports['__napi_register__get_buffer_379']?.()
  __napiInstance.exports['__napi_register__get_buffer_slice_380']?.()
  __napiInstance.exports['__napi_register__append_buffer_381']?.()
  __napiInstance.exports['__napi_register__get_empty_buffer_382']?.()
  __napiInstance.exports['__napi_register__create_external_buffer_slice_383']?.()
  __napiInstance.exports['__napi_register__create_buffer_slice_from_copied_data_384']?.()
  __napiInstance.exports['__napi_register__get_empty_typed_array_385']?.()
  __napiInstance.exports['__napi_register__convert_u32_array_386']?.()
  __napiInstance.exports['__napi_register__create_external_typed_array_387']?.()
  __napiInstance.exports['__napi_register__mutate_typed_array_388']?.()
  __napiInstance.exports['__napi_register__deref_uint8_array_389']?.()
  __napiInstance.exports['__napi_register__buffer_pass_through_390']?.()
  __napiInstance.exports['__napi_register__buffer_with_async_block_391']?.()
  __napiInstance.exports['__napi_register__array_buffer_pass_through_392']?.()
  __napiInstance.exports['__napi_register__accept_slice_393']?.()
  __napiInstance.exports['__napi_register__accept_arraybuffer_394']?.()
  __napiInstance.exports['__napi_register__create_arraybuffer_395']?.()
  __napiInstance.exports['__napi_register__u8_array_to_array_396']?.()
  __napiInstance.exports['__napi_register__i8_array_to_array_397']?.()
  __napiInstance.exports['__napi_register__u16_array_to_array_398']?.()
  __napiInstance.exports['__napi_register__i16_array_to_array_399']?.()
  __napiInstance.exports['__napi_register__u32_array_to_array_400']?.()
  __napiInstance.exports['__napi_register__i32_array_to_array_401']?.()
  __napiInstance.exports['__napi_register__f32_array_to_array_402']?.()
  __napiInstance.exports['__napi_register__f64_array_to_array_403']?.()
  __napiInstance.exports['__napi_register__u64_array_to_array_404']?.()
  __napiInstance.exports['__napi_register__i64_array_to_array_405']?.()
  __napiInstance.exports['__napi_register__accept_uint8_clamped_slice_406']?.()
  __napiInstance.exports['__napi_register__accept_uint8_clamped_slice_and_buffer_slice_407']?.()
  __napiInstance.exports['__napi_register__AsyncBuffer_impl_408']?.()
  __napiInstance.exports['__napi_register__async_reduce_buffer_409']?.()
  __napiInstance.exports['__napi_register__async_buffer_to_array_410']?.()
  __napiInstance.exports['__napi_register__u_init8_array_from_string_411']?.()
  __napiInstance.exports['__napi_register__AsyncReader_impl_412']?.()
  __napiInstance.exports['__napi_register__Reader_struct_413']?.()
  __napiInstance.exports['__napi_register__Reader_impl_415']?.()
}
