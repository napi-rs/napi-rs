...
function __napi_rs_initialize_modules(__napiInstance) {
  ...
  __napiInstance.exports['__napi_register__create_readable_stream_from_class_333']?.()
  __napiInstance.exports['__napi_register__contains_334']?.()
  __napiInstance.exports['__napi_register__concat_str_335']?.()
  __napiInstance.exports['__napi_register__concat_utf16_336']?.()
  __napiInstance.exports['__napi_register__concat_latin1_337']?.()
  __napiInstance.exports['__napi_register__roundtrip_str_338']?.()
  __napiInstance.exports['__napi_register__return_c_string_339']?.()
  __napiInstance.exports['__napi_register__set_symbol_in_obj_340']?.()
  __napiInstance.exports['__napi_register__create_symbol_341']?.()
  __napiInstance.exports['__napi_register__create_symbol_for_342']?.()
  __napiInstance.exports['__napi_register__DelaySum_impl_343']?.()
  __napiInstance.exports['__napi_register__without_abort_controller_344']?.()
  __napiInstance.exports['__napi_register__with_abort_controller_345']?.()
  __napiInstance.exports['__napi_register__AsyncTaskVoidReturn_impl_346']?.()
  __napiInstance.exports['__napi_register__async_task_void_return_347']?.()
  __napiInstance.exports['__napi_register__AsyncTaskOptionalReturn_impl_348']?.()
  __napiInstance.exports['__napi_register__async_task_optional_return_349']?.()
  __napiInstance.exports['__napi_register__AsyncTaskReadFile_impl_350']?.()
  __napiInstance.exports['__napi_register__async_task_read_file_351']?.()
  __napiInstance.exports['__napi_register__call_threadsafe_function_352']?.()
  __napiInstance.exports['__napi_register__call_long_threadsafe_function_353']?.()
  __napiInstance.exports['__napi_register__threadsafe_function_throw_error_354']?.()
  __napiInstance.exports['__napi_register__threadsafe_function_fatal_mode_355']?.()
  __napiInstance.exports['__napi_register__threadsafe_function_fatal_mode_error_356']?.()
  __napiInstance.exports['__napi_register__threadsafe_function_closure_capture_357']?.()
  __napiInstance.exports['__napi_register__tsfn_call_with_callback_358']?.()
  __napiInstance.exports['__napi_register__tsfn_async_call_359']?.()
  __napiInstance.exports['__napi_register__accept_threadsafe_function_360']?.()
  __napiInstance.exports['__napi_register__accept_threadsafe_function_fatal_361']?.()
  __napiInstance.exports['__napi_register__accept_threadsafe_function_tuple_args_362']?.()
  __napiInstance.exports['__napi_register__tsfn_return_promise_363']?.()
  __napiInstance.exports['__napi_register__tsfn_return_promise_timeout_364']?.()
  __napiInstance.exports['__napi_register__tsfn_throw_from_js_365']?.()
  __napiInstance.exports['__napi_register__spawn_thread_in_thread_366']?.()
  __napiInstance.exports['__napi_register__Pet_struct_367']?.()
  __napiInstance.exports['__napi_register__tsfn_in_either_368']?.()
  __napiInstance.exports['__napi_register__MyVec_struct_369']?.()
  __napiInstance.exports['__napi_register__get_my_vec_370']?.()
  __napiInstance.exports['__napi_register__CustomU32_371']?.()
  __napiInstance.exports['__napi_register__MyPromise_372']?.()
  __napiInstance.exports['__napi_register__Nullable_373']?.()
  __napiInstance.exports['__napi_register__VoidNullable_374']?.()
  __napiInstance.exports['__napi_register__RuleHandler_375']?.()
  __napiInstance.exports['__napi_register__Rule_struct_376']?.()
  __napiInstance.exports['__napi_register__call_rule_handler_377']?.()
  __napiInstance.exports['__napi_register__get_buffer_378']?.()
  __napiInstance.exports['__napi_register__get_buffer_slice_379']?.()
  __napiInstance.exports['__napi_register__append_buffer_380']?.()
  __napiInstance.exports['__napi_register__get_empty_buffer_381']?.()
  __napiInstance.exports['__napi_register__create_external_buffer_slice_382']?.()
  __napiInstance.exports['__napi_register__create_buffer_slice_from_copied_data_383']?.()
  __napiInstance.exports['__napi_register__get_empty_typed_array_384']?.()
  __napiInstance.exports['__napi_register__convert_u32_array_385']?.()
  __napiInstance.exports['__napi_register__create_external_typed_array_386']?.()
  __napiInstance.exports['__napi_register__mutate_typed_array_387']?.()
  __napiInstance.exports['__napi_register__deref_uint8_array_388']?.()
  __napiInstance.exports['__napi_register__buffer_pass_through_389']?.()
  __napiInstance.exports['__napi_register__buffer_with_async_block_390']?.()
  __napiInstance.exports['__napi_register__array_buffer_pass_through_391']?.()
  __napiInstance.exports['__napi_register__accept_slice_392']?.()
  __napiInstance.exports['__napi_register__accept_arraybuffer_393']?.()
  __napiInstance.exports['__napi_register__create_arraybuffer_394']?.()
  __napiInstance.exports['__napi_register__u8_array_to_array_395']?.()
  __napiInstance.exports['__napi_register__i8_array_to_array_396']?.()
  __napiInstance.exports['__napi_register__u16_array_to_array_397']?.()
  __napiInstance.exports['__napi_register__i16_array_to_array_398']?.()
  __napiInstance.exports['__napi_register__u32_array_to_array_399']?.()
  __napiInstance.exports['__napi_register__i32_array_to_array_400']?.()
  __napiInstance.exports['__napi_register__f32_array_to_array_401']?.()
  __napiInstance.exports['__napi_register__f64_array_to_array_402']?.()
  __napiInstance.exports['__napi_register__u64_array_to_array_403']?.()
  __napiInstance.exports['__napi_register__i64_array_to_array_404']?.()
  __napiInstance.exports['__napi_register__accept_uint8_clamped_slice_405']?.()
  __napiInstance.exports['__napi_register__accept_uint8_clamped_slice_and_buffer_slice_406']?.()
  __napiInstance.exports['__napi_register__AsyncBuffer_impl_407']?.()
  __napiInstance.exports['__napi_register__async_reduce_buffer_408']?.()
  __napiInstance.exports['__napi_register__async_buffer_to_array_409']?.()
  __napiInstance.exports['__napi_register__u_init8_array_from_string_410']?.()
  __napiInstance.exports['__napi_register__AsyncReader_impl_411']?.()
  __napiInstance.exports['__napi_register__Reader_struct_412']?.()
  __napiInstance.exports['__napi_register__Reader_impl_414']?.()
}
