...
function __napi_rs_initialize_modules(__napiInstance) {
  ...
  __napiInstance.exports['__napi_register__StringUnionEnum1_161']?.()
  __napiInstance.exports['__napi_register__StringUnionEnum2_162']?.()
  __napiInstance.exports['__napi_register__run_script_163']?.()
  __napiInstance.exports['__napi_register__get_module_file_name_164']?.()
  __napiInstance.exports['__napi_register__throw_syntax_error_165']?.()
  __napiInstance.exports['__napi_register__throw_error_166']?.()
  __napiInstance.exports['__napi_register__panic_167']?.()
  __napiInstance.exports['__napi_register__receive_string_168']?.()
  __napiInstance.exports['__napi_register__custom_status_code_169']?.()
  ...
  __napiInstance.exports['__napi_register__async_plus_100_284']?.()
  __napiInstance.exports['__napi_register__call_then_on_promise_285']?.()
  __napiInstance.exports['__napi_register__call_catch_on_promise_286']?.()
  __napiInstance.exports['__napi_register__call_finally_on_promise_287']?.()
  __napiInstance.exports['__napi_register__JsRepo_struct_288']?.()
  __napiInstance.exports['__napi_register__JsRepo_impl_291']?.()
  __napiInstance.exports['__napi_register__JsRemote_struct_292']?.()
  __napiInstance.exports['__napi_register__JsRemote_impl_295']?.()
  __napiInstance.exports['__napi_register__CSSRuleList_struct_296']?.()
  __napiInstance.exports['__napi_register__CSSRuleList_impl_300']?.()
  __napiInstance.exports['__napi_register__CSSStyleSheet_struct_301']?.()
  __napiInstance.exports['__napi_register__AnotherCSSStyleSheet_struct_302']?.()
  __napiInstance.exports['__napi_register__AnotherCSSStyleSheet_impl_304']?.()
  __napiInstance.exports['__napi_register__CSSStyleSheet_impl_308']?.()
  __napiInstance.exports['__napi_register__PackageJson_struct_309']?.()
  __napiInstance.exports['__napi_register__read_package_json_310']?.()
  __napiInstance.exports['__napi_register__get_package_json_name_311']?.()
  __napiInstance.exports['__napi_register__test_serde_roundtrip_312']?.()
  __napiInstance.exports['__napi_register__test_serde_big_number_precision_313']?.()
  __napiInstance.exports['__napi_register__test_serde_buffer_bytes_314']?.()
  __napiInstance.exports['__napi_register__return_from_shared_crate_315']?.()
  __napiInstance.exports['__napi_register__contains_316']?.()
  __napiInstance.exports['__napi_register__concat_str_317']?.()
  __napiInstance.exports['__napi_register__concat_utf16_318']?.()
  __napiInstance.exports['__napi_register__concat_latin1_319']?.()
  __napiInstance.exports['__napi_register__roundtrip_str_320']?.()
  __napiInstance.exports['__napi_register__set_symbol_in_obj_321']?.()
  __napiInstance.exports['__napi_register__create_symbol_322']?.()
  __napiInstance.exports['__napi_register__create_symbol_for_323']?.()
  __napiInstance.exports['__napi_register__DelaySum_impl_324']?.()
  __napiInstance.exports['__napi_register__without_abort_controller_325']?.()
  __napiInstance.exports['__napi_register__with_abort_controller_326']?.()
  __napiInstance.exports['__napi_register__AsyncTaskVoidReturn_impl_327']?.()
  __napiInstance.exports['__napi_register__async_task_void_return_328']?.()
  __napiInstance.exports['__napi_register__AsyncTaskOptionalReturn_impl_329']?.()
  __napiInstance.exports['__napi_register__async_task_optional_return_330']?.()
  __napiInstance.exports['__napi_register__AsyncTaskReadFile_impl_331']?.()
  __napiInstance.exports['__napi_register__async_task_read_file_332']?.()
  __napiInstance.exports['__napi_register__call_threadsafe_function_333']?.()
  __napiInstance.exports['__napi_register__call_long_threadsafe_function_334']?.()
  __napiInstance.exports['__napi_register__threadsafe_function_throw_error_335']?.()
  __napiInstance.exports['__napi_register__threadsafe_function_fatal_mode_336']?.()
  __napiInstance.exports['__napi_register__threadsafe_function_fatal_mode_error_337']?.()
  __napiInstance.exports['__napi_register__threadsafe_function_closure_capture_338']?.()
  __napiInstance.exports['__napi_register__tsfn_call_with_callback_339']?.()
  __napiInstance.exports['__napi_register__tsfn_async_call_340']?.()
  __napiInstance.exports['__napi_register__accept_threadsafe_function_341']?.()
  __napiInstance.exports['__napi_register__accept_threadsafe_function_fatal_342']?.()
  __napiInstance.exports['__napi_register__accept_threadsafe_function_tuple_args_343']?.()
  __napiInstance.exports['__napi_register__tsfn_return_promise_344']?.()
  __napiInstance.exports['__napi_register__tsfn_return_promise_timeout_345']?.()
  __napiInstance.exports['__napi_register__tsfn_throw_from_js_346']?.()
  __napiInstance.exports['__napi_register__spawn_thread_in_thread_347']?.()
  __napiInstance.exports['__napi_register__Pet_struct_348']?.()
  __napiInstance.exports['__napi_register__tsfn_in_either_349']?.()
  __napiInstance.exports['__napi_register__get_buffer_350']?.()
  __napiInstance.exports['__napi_register__get_buffer_slice_351']?.()
  __napiInstance.exports['__napi_register__append_buffer_352']?.()
  __napiInstance.exports['__napi_register__get_empty_buffer_353']?.()
  __napiInstance.exports['__napi_register__create_external_buffer_slice_354']?.()
  __napiInstance.exports['__napi_register__create_buffer_slice_from_copied_data_355']?.()
  __napiInstance.exports['__napi_register__get_empty_typed_array_356']?.()
  __napiInstance.exports['__napi_register__convert_u32_array_357']?.()
  __napiInstance.exports['__napi_register__create_external_typed_array_358']?.()
  __napiInstance.exports['__napi_register__mutate_typed_array_359']?.()
  __napiInstance.exports['__napi_register__deref_uint8_array_360']?.()
  __napiInstance.exports['__napi_register__buffer_pass_through_361']?.()
  __napiInstance.exports['__napi_register__array_buffer_pass_through_362']?.()
  __napiInstance.exports['__napi_register__accept_slice_363']?.()
  __napiInstance.exports['__napi_register__accept_arraybuffer_364']?.()
  __napiInstance.exports['__napi_register__create_arraybuffer_365']?.()
  __napiInstance.exports['__napi_register__u8_array_to_array_366']?.()
  __napiInstance.exports['__napi_register__i8_array_to_array_367']?.()
  __napiInstance.exports['__napi_register__u16_array_to_array_368']?.()
  __napiInstance.exports['__napi_register__i16_array_to_array_369']?.()
  __napiInstance.exports['__napi_register__u32_array_to_array_370']?.()
  __napiInstance.exports['__napi_register__i32_array_to_array_371']?.()
  __napiInstance.exports['__napi_register__f32_array_to_array_372']?.()
  __napiInstance.exports['__napi_register__f64_array_to_array_373']?.()
  __napiInstance.exports['__napi_register__u64_array_to_array_374']?.()
  __napiInstance.exports['__napi_register__i64_array_to_array_375']?.()
  __napiInstance.exports['__napi_register__accept_uint8_clamped_slice_376']?.()
  __napiInstance.exports['__napi_register__accept_uint8_clamped_slice_and_buffer_slice_377']?.()
  __napiInstance.exports['__napi_register__AsyncBuffer_impl_378']?.()
  __napiInstance.exports['__napi_register__async_reduce_buffer_379']?.()
  __napiInstance.exports['__napi_register__async_buffer_to_array_380']?.()
  __napiInstance.exports['__napi_register__u_init8_array_from_string_381']?.()
  __napiInstance.exports['__napi_register__AsyncReader_impl_382']?.()
  __napiInstance.exports['__napi_register__Reader_struct_383']?.()
  __napiInstance.exports['__napi_register__Reader_impl_385']?.()
}
