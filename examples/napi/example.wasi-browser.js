...
function __napi_rs_initialize_modules(__napiInstance) {
  ...
  __napiInstance.exports['__napi_register__async_plus_100_288']?.()
  __napiInstance.exports['__napi_register__call_then_on_promise_289']?.()
  __napiInstance.exports['__napi_register__call_catch_on_promise_290']?.()
  __napiInstance.exports['__napi_register__call_finally_on_promise_291']?.()
  __napiInstance.exports['__napi_register__JsRepo_struct_292']?.()
  __napiInstance.exports['__napi_register__JsRepo_impl_295']?.()
  __napiInstance.exports['__napi_register__JsRemote_struct_296']?.()
  __napiInstance.exports['__napi_register__JsRemote_impl_299']?.()
  __napiInstance.exports['__napi_register__CSSRuleList_struct_300']?.()
  __napiInstance.exports['__napi_register__CSSRuleList_impl_304']?.()
  __napiInstance.exports['__napi_register__CSSStyleSheet_struct_305']?.()
  __napiInstance.exports['__napi_register__AnotherCSSStyleSheet_struct_306']?.()
  __napiInstance.exports['__napi_register__AnotherCSSStyleSheet_impl_308']?.()
  __napiInstance.exports['__napi_register__CSSStyleSheet_impl_312']?.()
  __napiInstance.exports['__napi_register__PackageJson_struct_313']?.()
  __napiInstance.exports['__napi_register__read_package_json_314']?.()
  __napiInstance.exports['__napi_register__get_package_json_name_315']?.()
  __napiInstance.exports['__napi_register__test_serde_roundtrip_316']?.()
  __napiInstance.exports['__napi_register__test_serde_big_number_precision_317']?.()
  __napiInstance.exports['__napi_register__test_serde_buffer_bytes_318']?.()
  __napiInstance.exports['__napi_register__pass_set_to_rust_319']?.()
  __napiInstance.exports['__napi_register__pass_set_to_js_320']?.()
  __napiInstance.exports['__napi_register__btree_set_to_rust_321']?.()
  __napiInstance.exports['__napi_register__btree_set_to_js_322']?.()
  __napiInstance.exports['__napi_register__return_from_shared_crate_323']?.()
  __napiInstance.exports['__napi_register__contains_324']?.()
  __napiInstance.exports['__napi_register__concat_str_325']?.()
  __napiInstance.exports['__napi_register__concat_utf16_326']?.()
  __napiInstance.exports['__napi_register__concat_latin1_327']?.()
  __napiInstance.exports['__napi_register__roundtrip_str_328']?.()
  __napiInstance.exports['__napi_register__return_c_string_329']?.()
  __napiInstance.exports['__napi_register__set_symbol_in_obj_330']?.()
  __napiInstance.exports['__napi_register__create_symbol_331']?.()
  __napiInstance.exports['__napi_register__create_symbol_for_332']?.()
  __napiInstance.exports['__napi_register__DelaySum_impl_333']?.()
  __napiInstance.exports['__napi_register__without_abort_controller_334']?.()
  __napiInstance.exports['__napi_register__with_abort_controller_335']?.()
  __napiInstance.exports['__napi_register__AsyncTaskVoidReturn_impl_336']?.()
  __napiInstance.exports['__napi_register__async_task_void_return_337']?.()
  __napiInstance.exports['__napi_register__AsyncTaskOptionalReturn_impl_338']?.()
  __napiInstance.exports['__napi_register__async_task_optional_return_339']?.()
  __napiInstance.exports['__napi_register__AsyncTaskReadFile_impl_340']?.()
  __napiInstance.exports['__napi_register__async_task_read_file_341']?.()
  __napiInstance.exports['__napi_register__call_threadsafe_function_342']?.()
  __napiInstance.exports['__napi_register__call_long_threadsafe_function_343']?.()
  __napiInstance.exports['__napi_register__threadsafe_function_throw_error_344']?.()
  __napiInstance.exports['__napi_register__threadsafe_function_fatal_mode_345']?.()
  __napiInstance.exports['__napi_register__threadsafe_function_fatal_mode_error_346']?.()
  __napiInstance.exports['__napi_register__threadsafe_function_closure_capture_347']?.()
  __napiInstance.exports['__napi_register__tsfn_call_with_callback_348']?.()
  __napiInstance.exports['__napi_register__tsfn_async_call_349']?.()
  __napiInstance.exports['__napi_register__accept_threadsafe_function_350']?.()
  __napiInstance.exports['__napi_register__accept_threadsafe_function_fatal_351']?.()
  __napiInstance.exports['__napi_register__accept_threadsafe_function_tuple_args_352']?.()
  __napiInstance.exports['__napi_register__tsfn_return_promise_353']?.()
  __napiInstance.exports['__napi_register__tsfn_return_promise_timeout_354']?.()
  __napiInstance.exports['__napi_register__tsfn_throw_from_js_355']?.()
