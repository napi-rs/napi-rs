  ...
  ;({
    ...
    overwriteImports(importObject) {
      ...
      importObject.napi.napi_add_env_cleanup_hook = function (
        ...
        const scenario = state ? Atomics.load(state, TSFN_SCENARIO_INDEX) : 0
        const track =
          scenario !== 0 &&
...
export const abortBoundedTsfnFromOwnerAgent =
  __napiModule.exports.abortBoundedTsfnFromOwnerAgent
...
export const boundedTsfnOwnerAbortState =
  __napiModule.exports.boundedTsfnOwnerAbortState
...
export const finishBoundedTsfnOwnerAbort =
  __napiModule.exports.finishBoundedTsfnOwnerAbort
...
export const prepareBoundedTsfnOwnerAbort =
  __napiModule.exports.prepareBoundedTsfnOwnerAbort
...
export const releaseBoundedTsfnNativeWait =
  __napiModule.exports.releaseBoundedTsfnNativeWait
